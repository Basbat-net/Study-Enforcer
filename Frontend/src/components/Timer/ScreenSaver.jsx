...
export function ScreenSaver({
  ...
  return (
    <div className="screensaver-overlay" onClick={onDismiss}>
      ...
      >
        <div className="screensaver-time">{formattedTime}</div>
        <div className="screensaver-user">{currentUser || 'Timer'}</div>
      </div>
      ...
      >
        <div className="screensaver-title">Protector de pantalla</div>
        <div className="screensaver-hint">Toca para salir</div>
      </div>
    </div>
  );
}
